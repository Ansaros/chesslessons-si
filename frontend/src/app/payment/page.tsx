          ...
          <CardContent className="space-y-4">
            <div className="p-4 bg-green-50 rounded-lg">
              <p className="text-sm text-green-700">
                Вы можете начать просмотр прямо сейчас. Видео также доступно в
                вашем профиле.
              </p>
            </div>
                    ...
                    {selectedMethod === "bank" && (
                      <div className="p-4 bg-blue-50 rounded-lg">
                        ...
                        <p className="text-xs text-blue-600">
                          Доступ к видео будет активирован после поступления
                          средств (обычно в течение 1-2 рабочих дней).
                        </p>
                      </div>
                    )}
