      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center">
          ...
          <h2 className="text-4xl md:text-6xl font-bold text-slate-800 mb-6">
            Изучайте шахматы в{" "}
            <span className="text-green-600">Chester Chess Club</span>
          </h2>
          <p className="text-xl text-slate-600 mb-8 max-w-2xl mx-auto">
            Профессиональные видеоуроки от гроссмейстеров и международных
            мастеров. Повысьте свой уровень игры с нашими структурированными
            курсами.
          </p>
                ...
                <CardContent>
                  <Button className="w-full" asChild>
                    <Link href={`/video/${video.id}`}>
                      {video.access === 0 ? "Смотреть" : "Купить и смотреть"}
                    </Link>
                  </Button>
                </CardContent>
              </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-slate-300">
                Профессиональное обучение шахматам онлайн
              </p>
            </div>
            <div>
