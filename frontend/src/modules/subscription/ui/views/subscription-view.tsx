        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
            ...
            <div className="container mx-auto px-4 py-12">
                <div className="text-center mb-12">
                    <h1 className="text-4xl font-bold text-slate-800 mb-4">Выберите подходящий план</h1>
                    <p className="text-xl text-slate-600 max-w-2xl mx-auto">
                        Получите неограниченный доступ к видеоурокам, соответствующим вашему уровню игры
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                    {subscriptionPlans.map((plan) => (
                        <Card
                            key={plan.id}
                            className={`relative overflow-hidden transition-all duration-300 hover:shadow-xl ${plan.color} ${plan.popular ? "border-2 scale-105" : "border"
                                }`}
                        >
                            {plan.popular && (
                            ...
                            <CardContent>
                                ...
                                <div className="mb-6">
                                    <p className="text-sm font-medium text-slate-700 mb-2">Доступные уровни:</p>
                                ...
                                <Button className={`w-full py-3 text-lg ${plan.buttonColor}`} onClick={() => setSelectedPlan(plan.id)}>
                ...
                <div className="text-center mt-12">
                    <p className="text-slate-600 mb-4">Все планы включают 7-дневный бесплатный пробный период</p>
